...
- (void) initialize{
    ...
    UIImage *tableHeaderImage = [UIImage imageNamed:@"current_location.png"];
...
- (void) initializeWithFrame:(CGRect)frame{
    ...
    UIImageView *headerImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"current_location.png"]];
    headerImageView.frame = CGRectMake(10,(frame.size.height - 35) / 2,22,35);
    ...
    indicatorImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"indicator.png"]];
    indicatorImage.frame = CGRectMake(frame.origin.x + frame.size.width - 14 - 10,(frame.size.height - 21) / 2,14,21);
...
{
    [self setBackgroundColor:[UIColor colorWithRed:243.0f/255.0f green:173.0f/255.0f blue:75.0f/255.0f alpha:1.0f]];
}

-(void)touchesCancelled:(NSSet *)touches withEvent:(UIEvent *)event
{
    [self setBackgroundColor:[UIColor colorWithRed:223.0f/255.0f green:223.0f/255.0f blue:223.0f/255.0f alpha:1.0f]];
}
